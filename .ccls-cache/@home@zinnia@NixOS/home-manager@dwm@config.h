...
#include "center.c"
#include "uselessgap.c"
#include "focusonclick.c"
#include "focusurgent.c"
#include "restart.c"


/* Appearance */
static const char *fonts[] = { "SauceCodePro Nerd Font:size=14", "Cantarell:size=14" };

// Bar
static const int showbar           = 1; // 1 means true
static const int topbar            = 1;

// Colors
static const char normbordercolor[] = "#f0c6c6"; //flamingo
static const char normbgcolor[]     = "#24273a"; //base
static const char normfgcolor[]     = "#cad3f5"; //text
static const char selbordercolor[]  = "#f5bde6"; //pink
static const char selbgcolor[]      = "#24273a"; //base
static const char selfgcolor[]      = "#cad3f5"; //text

#if URGENT_BORDER
static const char urgbordercolor[]  = "#ee99a0"; //maroon
#endif

static const char dmenubgcolor[]    = "#24273a"; //base
...
#if FOCUS_ON_CLICK
static const int focusonwheelscroll = 0; // scroll wheel won't change focus
#endif
